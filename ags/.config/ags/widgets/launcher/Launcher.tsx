...
export default function Launcher(gdkmonitor: Gdk.Monitor) {
  ...
  return (
    ...
    >
      <box cssClasses={["launcher-inner"]} css="background-color: #1a1a2e; border-radius: 18px; margin: 8px; min-width: 580px;" orientation={Gtk.Orientation.VERTICAL} halign={Gtk.Align.CENTER} valign={Gtk.Align.END}>
