...
Item {
    ...
    readonly property int minWidth: Config.dashboard.sizes.heroCardMinWidth * 2 + Appearance.spacing.normal + Config.dashboard.sizes.batteryWidth + Appearance.padding.large * 2
    ...
    StyledRect {
        ...
        width: Config.dashboard.sizes.placeholderWidth
        height: Config.dashboard.sizes.placeholderHeight
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                HeroCard {
                    Layout.fillWidth: true
                    Layout.minimumWidth: Config.dashboard.sizes.heroCardMinWidth
                    Layout.preferredHeight: Config.dashboard.sizes.heroCardHeight
            ...
            RowLayout {
                ...
                GaugeCard {
                    Layout.minimumWidth: Config.dashboard.sizes.gaugeCardMinWidth
                    Layout.preferredHeight: Config.dashboard.sizes.gaugeCardHeight
                ...
                NetworkCard {
                    Layout.fillWidth: true
                    Layout.minimumWidth: Config.dashboard.sizes.networkCardMinWidth
                    Layout.preferredHeight: Config.dashboard.sizes.gaugeCardHeight
        ...
        BatteryTank {
            Layout.preferredWidth: Config.dashboard.sizes.batteryWidth
